...
# options override; linked into the ASan binary below so the hook is actually resolved.
$CC $SANITIZER_FLAGS $GO_DEBUG_FLAGS -c "$SRC/mayhem/lsan_off.c" -o "$SRC/mayhem-build/lsan_off.o"
